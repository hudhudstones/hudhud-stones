...
- [x] Create admin_users table with username, password hash, email
- [x] Create login page with username/password form
- [x] Implement session-based authentication for admin
- [ ] Add admin user management in dashboard settings
- [x] Create initial admin user (Tarek/Tarek123_)
- [x] Protect admin routes with auth guard
